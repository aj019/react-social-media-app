...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps){
      ...
      if(nextProps.profile.profile){
        ...
        profile.githubusername = !isEmpty(profile.social.githubusername) ? profile.social.githubusername : '';
...
export default connect(mapsStateToProps,{createProfile,getCurrentProfile})(withRouter(CreateProfile))